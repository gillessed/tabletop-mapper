...
export function AssetPanel() {
  ...
  const filteredState = React.useMemo(
    () => filterAssets(assetState, searchKeys),
    [assetState, searchKeys]
  );
  ...
  return (
    <div
      className={classNames("asset-tree-container", {
        "dragging-asset": mouseMode === Grid.Types.MouseMode.DragAsset,
      })}
